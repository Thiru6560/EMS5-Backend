...
public class Wednesday {
	...
	public Wednesday(Long wed_id, Time shiftStartTime, Time shiftEndTime, Time lunchBreakStartTime,
			Time lunchBreakEndTime, Integer takeLunchBreakBeforeMinute, Time teaBreakStartTime, Time teaBreakEndTime,
	...
	public Long getWed_id() {
		return wed_id;
	}

	public void setWed_id(Long wed_id) {
		this.wed_id = wed_id;
	}

...
public class Friday {
	...
	private LocalTime maximumPunchOutTime;

	private Integer maximumPunchOutHours;

	public Friday(Long fri_id, Time shiftStartTime, Time shiftEndTime, Time lunchBreakStartTime, Time lunchBreakEndTime,
			...
			Integer maximumPersonalBreak, LocalTime maximumPunchOutTime, Integer maximumPunchOutHours) {
		super();
		this.fri_id = fri_id;
	...
	public Long getFri_id() {
		return fri_id;
	}

	public void setFri_id(Long fri_id) {
		this.fri_id = fri_id;
	}
	...
	public LocalTime getMaximumPunchOutTime() {
		return maximumPunchOutTime;
	}

	public void setMaximumPunchOutTime(LocalTime maximumPunchOutTime) {
		this.maximumPunchOutTime = maximumPunchOutTime;
	}
